            ...
            <section className='w-full'>
                  <div className='flex  md:flex-row  flex-col-reverse md:space-x-8 items-center justify-between'>
                        <div className='space-y-6 mt-12 md:mt-0 md:w-[80%]'>
                              <h1 className='text-5xl sm:text-5xl lg:text-6xl leading-[1.2] font-semibold'>The growth patner for your business</h1>
                              ...
                              <br /> 
                              <button className='md:py-[14px] hidden fixed md:static bottom-0 right-0 p-8  left-0 md:px-[32px] text-sm font-medium md:bg-green-500/90 bg-green-500 md:hover:bg-green-500/80 md:rounded '>join the waiting list</button>
                        </div>
